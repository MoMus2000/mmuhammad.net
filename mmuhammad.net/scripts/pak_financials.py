...
url = f'https://www.alphavantage.co/query?function=TIME_SERIES_INTRADAY&symbol=XRE.TO&interval=1min&apikey={ALPHA_API_TOKEN}'
r = requests.get(url)
if r.status_code == 200:
    ...
    cur = con.cursor()
    data = (
        [today_date, "CLOSE_XRE.TO", close_price],
    )
    try:
